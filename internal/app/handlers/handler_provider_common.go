...
// filterProviderScopedEndpoints applies provider-type filtering without falling
// back to unrelated endpoint types. Provider routes must fail closed when no
// matching provider endpoints are available.
